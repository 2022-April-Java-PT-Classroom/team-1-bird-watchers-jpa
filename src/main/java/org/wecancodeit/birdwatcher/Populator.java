...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Country peru = new Country("Peru", "With more than 1800 bird species, Peru is one of the best tropical birdwatching destinations in South America. Our guides guides have years of experience navigating through the different regions in Peru, and will guide you to some of the most biologically righ areas in Peru. Whether you want to see the many species of birds that live along the Andes, or the Coast, we know for certain you will enjoy your birdwatching excursion in Peru.", "static/Images/CountryPeru.jpg");
        ...
        Habitat beach = new Habitat("Beach", "Peru's Pacific coastline stretches for 1,500 miles along the Western side of the nation. Within the coast, there are a variety of landscapes, from desert-like landscapes, rocky cliffs, and white sandy tropical beaches. If seeing the emporer penguins that call this area home is something you have on your bucket list of birds, or if you would like to see the other shore birds, than consider booking a birding trip to the beaches of Peru.", "static/Images/Beach.jpeg");
        Habitat galapagos = new Habitat("Galapagos Islands","The Galapagos islands, which are part of the Ecuador are a group of volcanic islands. This geographic location is known for it's large number of endemic species, which includes its birds. Inspired by the documented voyages of Charles Darwin, the father of evolutionary theory, people come here to see the species finches, which all have unique adaptations in their beaks and size! In addition to the finches, there are so many other species that you will find nowhere else on the planet! This is an area that people dream of visiting, and we can help you fulfill that dream.", "static/Images/Galapagos.jpg");
        ...
        Habitat rainforest = new Habitat("Amazon Rainforest", "The rainforest that lie along the Amazon river basin, is a moist, biologically rich tropical biome. One in ten species in the world lives in the Amazon rainforest! This includes over 2000 species of birds. You don't have to walk far in the rainforests of the Amazon to see a variety of birds. Our guides are experienced at navigating our clients through this terrain, and take pleasure in showing our clients the biological diversity that this beautiful location has to offer.", "static/Images/Rainforest.jpg");

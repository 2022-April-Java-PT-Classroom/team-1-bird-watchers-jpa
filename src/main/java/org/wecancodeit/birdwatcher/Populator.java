...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Bird macaw = new Bird ("Scarlet Macaw", "static/Images/rainforest_macaw.jpeg", "A large, red, yellow, and blue parrot, native to many tropical regions, including the rainforests of peru. The Scarlet Macaw has a mainly red body, with yellow and blue markings on its wings. They are giant parrots, that are about 32 inches in length.", "Psittaciformes", "Ecuador", "Forest", "Amazon Rainforest");
        Bird toucan = new Bird ("Toucan", "static/Images/rainforest_toucan.jpeg", "A large bird with an unmistakingly-large,  black yellow and blue beak. They are about 25 inches in length, with a beak of about 9 inches. Their color is primarily black, with a white throat.", "Piciformes", "Ecuador", "Forest", "Amazon Rainforest");
